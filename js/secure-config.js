...
class SecureConfig {
  ...
  async uploadBannerToGitHub(file, position, projectName, linkUrl, endDate) {
    console.log('🎯 Using direct GitHub API upload with GitHub Secrets');
    ...
    try {
      ...
      console.log(`📁 Uploading banner directly to GitHub: ${fileName}`);
      ...
      console.log('✅ Banner uploaded successfully to GitHub!');
